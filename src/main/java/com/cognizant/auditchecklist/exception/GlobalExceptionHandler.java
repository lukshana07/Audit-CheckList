...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
	...
	@ExceptionHandler(AuditCheckListNotFoundException.class)
	public ResponseEntity<ExceptionDetails> handleCheckListNotFoundException(AuditCheckListNotFoundException ex) {
	...
	public ResponseEntity<ExceptionDetails> handleMissingRequestHeaderException(Exception ex) {
